...
function imdbLink () {
  movies.forEach(function(movie) {
        ...
        listName.appendChild(imdb_Link);
  })
}
*/
// Adds all movies
...
function addAvengersMoviesToDom() {

  const avengersMovies = movies.filter((name) => name.Title.includes("Avengers"))

  avengersMovies.forEach(function(movie) {
    let a   = document.createElement('a');
    let img = document.createElement("img");
    a.href  = 'http://www.imdb.com/title/' + movie.imdbID;
    img.src = movie.Poster;
...
//Adds xmen
function addXmenMoviesToDom() {

  const xmenMovies = movies.filter((name) => name.Title.includes("X-Men"))

  xmenMovies.forEach(function(movie) {
    let a   = document.createElement('a');
    let img = document.createElement("img");
    a.href  = 'http://www.imdb.com/title/' + movie.imdbID;
    img.src = movie.Poster;
...
//Adds princess
function addPrincessMoviesToDom() {

  const princessMovies = movies.filter((name) => name.Title.includes("Princess"))

  princessMovies.forEach(function(movie) {
    let a   = document.createElement('a');
    let img = document.createElement("img");
    a.href  = 'http://www.imdb.com/title/' + movie.imdbID;
    img.src = movie.Poster;
...
// adds batmman
function addBatmanMoviesToDom() {

  const batmanMovies = movies.filter((name) => name.Title.includes("Batman"))

  batmanMovies.forEach(function(movie) {
    let a   = document.createElement('a');
    let img = document.createElement("img");
    a.href  = 'http://www.imdb.com/title/' + movie.imdbID;
    img.src = movie.Poster;
